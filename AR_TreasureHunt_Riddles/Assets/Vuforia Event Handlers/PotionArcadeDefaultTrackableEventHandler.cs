...
/// </summary>
public class PotionArcadeDefaultTrackableEventHandler : MonoBehaviour, ITrackableEventHandler
{
    ...
    protected virtual void OnTrackingFound()
    {
            ...
            GameObject.Find("ArcadeMachine").GetComponent<MiniGameArcade>().isArcadeMiniGameCompleted == false)
        {
            ...
            GameObject.Find("Startscreen").GetComponent<textBubble>().arkade[0].audArray[0].Play();
        }
    }
