...
/// </summary>
public class PotionCulpritDefaultTrackableEventHandler : MonoBehaviour, ITrackableEventHandler
{
    ...
    protected virtual void OnTrackingFound()
    {
        ...
        GameObject.Find("ArcadeMachine").GetComponent<MiniGameArcade>().isArcadeMiniGameCompleted == false)
        {
            ...
            GameObject.Find("Startscreen").GetComponent<textBubble>().crime[0].audArray[0].Play();
        }
    }
