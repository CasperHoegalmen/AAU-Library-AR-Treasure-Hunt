...
/// </summary>
public class PotionGingerDefaultTrackableEventHandler : MonoBehaviour, ITrackableEventHandler
{
    ...
    protected virtual void OnTrackingFound()
    {
        ...
        {
            GameObject.Find("Startscreen").GetComponent<textBubble>().zone[0].current = true;
            GameObject.Find("Startscreen").GetComponent<textBubble>().pressCount = 1;
            GameObject.Find("Startscreen").GetComponent<textBubble>().zone[0].audArray[0].Play();
        }
    }
