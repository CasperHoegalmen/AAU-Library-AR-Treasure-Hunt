...
/// </summary>
public class ThirdPotionGingerDefaultTrackableEventHandler : MonoBehaviour, ITrackableEventHandler
{
    ...
    protected virtual void OnTrackingFound()
    {
        ...
        {
            GameObject.Find("Startscreen").GetComponent<textBubble>().zone[2].current = true;
            GameObject.Find("Startscreen").GetComponent<textBubble>().pressCount = 1;
            GameObject.Find("Startscreen").GetComponent<textBubble>().zone[2].audArray[0].Play();
        }
    }
