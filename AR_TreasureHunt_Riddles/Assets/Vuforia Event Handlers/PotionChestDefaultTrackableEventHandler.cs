...
/// </summary>
public class PotionChestDefaultTrackableEventHandler : MonoBehaviour, ITrackableEventHandler
{
    ...
    protected virtual void OnTrackingFound()
    {
            ...
            GameObject.Find("ArcadeMachine").GetComponent<MiniGameArcade>().isArcadeMiniGameCompleted == false)
        {
            ...
            GameObject.Find("Startscreen").GetComponent<textBubble>().introContinued.audArray[0].Play();
        }
    }
